...
skill `capability`**, que ofrece la que corresponde y deja que tu cliente decida.
...
<!-- Las acciones sensibles de cada empresa NO van acá: este bloque se
     ...
     empresa no se hace sin permiso" de 00-identity.md, arriba del marcador. -->
...
Usá la skill `approval` (tiene el formato y los pasos). Dos cosas que tenés
...
capacidad— y se pide como lo que es, una sola vez, con la skill `capability`.
