...
(`kit/plugins/<id>/`), manifest and all. This module is the BOOT-TIME
...
`<root>/skills/`: `kit/skills/` in the repo, `/opt/skills` here -- and an
...
# `kit/`, registry `kit/plugins/`), which is why the one validator
