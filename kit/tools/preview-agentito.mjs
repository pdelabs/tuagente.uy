...
//
// Usage:  node kit/tools/preview-agentito.mjs   →  http://localhost:8077
//
...
async function paint() {
  ...
  document.getElementById("cli").textContent =
    "node kit/tools/draw-agentito.mjs --look '" + JSON.stringify(look) + "' --for telegram --png /tmp/agentito.png";
}
