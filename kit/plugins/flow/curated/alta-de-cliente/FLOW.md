...
client_summary: "Cuando le vendés a alguien nuevo, lo dejo cargado en tu planilla con todo lo que hace falta."
trigger_type: request
trigger_detail: Cada vez que se cierra una venta con alguien nuevo
skills: deliverable,artifact
results: entregables/clientes
status: active
---
