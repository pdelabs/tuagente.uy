...
plugins and `kit/skills/` holds only the two shadow notes. **Phase 5
...
One directory per plugin in the monorepo registry: `kit/plugins/<id>/`.
...
4. ~~**Porting wave:** everything that already existed becomes a plugin.~~
   **DONE 2026-08-23** (ab47fa8 `quotes`, `brand-kit`, `social-content`,
   ...
   migration. The registry is 13 plugins and `kit/skills/` is down to the
   two shadow notes.
