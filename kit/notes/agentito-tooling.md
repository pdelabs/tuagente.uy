...
**The CLI.** `kit/tools/draw-agentito.mjs` (Node; it stayed in JS-land
...
libs, deterministic bytes). Setup: `cd kit/tools && npm install`.

**Tests.** `python3 -m unittest discover -s kit/tools -p
