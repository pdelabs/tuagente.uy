...
PROFILE_CONFIG = """# Generated by roles/build_role.py -- do not edit by hand.
...
def write_profile_config(role: str, dest: Path) -> None:
    """The profile's config.yaml, which exists for one line (see PROFILE_CONFIG)."""
    (dest / "config.yaml").write_text(PROFILE_CONFIG.format(role=role), encoding="utf-8")
