---
nombre: Contenido diario para Instagram
para_cliente: "Todos los días a las 9:00 te dejo listo un post de feed y dos stories para aprobar."
gatillo_tipo: horario
gatillo_detalle: Todos los días a las 9:00, hora de Uruguay
gatillo_cron: "0 9 * * *"
skills: social-content,post-image,entregable
resultados: entregables/contenido-instagram-diario
estado: activo
---
