---
name: Contestar fuera de hora
client_summary: "Cuando te escriben y no hay nadie, dejo la respuesta lista para que la apruebes apenas puedas."
trigger_type: request
trigger_detail: Cada vez que llega un mensaje fuera del horario de atención
skills: approval,transcribe
results: entregables/fuera-de-hora
status: active
---
