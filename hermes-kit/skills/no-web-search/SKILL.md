---
title: Cuando no podés buscar en internet
client_summary: "Le explica al agente qué hacer cuando necesita datos de internet y no tiene buscador."
name: no-web-search
...
El procedimiento completo está en la skill `capability`.
