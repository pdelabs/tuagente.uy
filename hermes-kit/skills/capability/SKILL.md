---
title: Pedir una capacidad
client_summary: "Cuando a tu agente le falta con qué hacer algo, te lo dice y te ofrece la capacidad que lo resuelve."
name: capability
...
# capability — cuando te falta con qué
...
3. **Buscá el id en el catálogo** (`references/catalog.md`). Si hay una
   capacidad que resuelve eso, escribí la mención **sola en una línea**:

   ```
   capability:social-package
   ```
