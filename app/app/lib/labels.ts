...
const BY_NAME: Record<string, Action> = {
  ...
  // THE ENGINE'S NOTEBOOK (`kit/plugins/memory/core/plugin.py`). `write_memory`
  // fell into the `write_` family below and read «Escribió lo suyo», which
  // says nothing about what the owner cares about: that it will remember.
  write_memory: { inProgress: "Anotando algo para acordarse", done: "Se anotó algo para acordarse" },
  read_memory: { inProgress: "Repasando lo que sabe de tu negocio", done: "Repasó lo que sabe de tu negocio" },
  search_memory: { inProgress: "Repasando lo que sabe de tu negocio", done: "Repasó lo que sabe de tu negocio" },
  delete_memory: { inProgress: "Borrando algo que tenía anotado", done: "Borró algo que tenía anotado" },
  // The engine's own tools and the plugins' (`engine/core/tools/`,
  // `kit/plugins/*/core/`), by name: their families below are too vague to
  // tell the owner which of her things it touched.
  list_files: { inProgress: "Mirando tus archivos", done: "Miró tus archivos" },
  create_flow: { inProgress: "Armando un flujo", done: "Armó un flujo" },
  set_flow_status: { inProgress: "Cambiando un flujo", done: "Cambió un flujo" },
  create_ticket: { inProgress: "Anotando una tarea en el tablero", done: "Anotó una tarea en el tablero" },
  read_ticket: { inProgress: "Mirando una tarea", done: "Miró una tarea" },
  update_ticket: { inProgress: "Actualizando una tarea", done: "Actualizó una tarea" },
  fetch_mail: { inProgress: "Revisando el correo", done: "Revisó el correo" },
  send_email: { inProgress: "Mandando un mail", done: "Mandó un mail" },
  save_post: { inProgress: "Guardando un posteo", done: "Guardó un posteo" },
  replace_slide: { inProgress: "Rehaciendo una imagen de un posteo", done: "Rehízo una imagen de un posteo" },
  view_slide: { inProgress: "Mirando una imagen de un posteo", done: "Miró una imagen de un posteo" },
  place_image: { inProgress: "Armando una imagen", done: "Armó una imagen" },
  generate_image: { inProgress: "Armando una imagen", done: "Armó una imagen" },
  update_caption: { inProgress: "Corrigiendo el texto de un posteo", done: "Corrigió el texto de un posteo" },
  publish_instagram: { inProgress: "Publicando en Instagram", done: "Publicó en Instagram" },
  fetch_comments: { inProgress: "Leyendo comentarios de Instagram", done: "Leyó comentarios de Instagram" },
  fetch_messages: { inProgress: "Leyendo mensajes de Instagram", done: "Leyó mensajes de Instagram" },
  reply_comment: { inProgress: "Contestando un comentario", done: "Contestó un comentario" },
  hide_comment: { inProgress: "Ocultando un comentario", done: "Ocultó un comentario" },
  recent_performance: { inProgress: "Mirando cómo les fue a tus posteos", done: "Miró cómo les fue a tus posteos" },
  save_draft: { inProgress: "Guardando el borrador de tu negocio", done: "Guardó el borrador de tu negocio" },
