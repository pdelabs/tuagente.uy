...
Lo último no se pide por ticket: **las capacidades se piden con la skill
`capacidad`**, que ofrece la que corresponde y deja que tu cliente decida. Es
más rápido para vos y más claro para él que una aprobación.
...
portal la convierte en una tarjeta. Si no la hay, decilo en una frase y seguí
con lo que sí podés hacer. Cuándo pedir y cuándo no, en la skill `capacidad`.
